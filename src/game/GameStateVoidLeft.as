package game 
{
	 ...
	 */
	public class GameStateVoidLeft extends FlxState 
	{
		[Embed(source = '../assets/Tile.png')] private var stoneBlock:Class;
		[Embed(source = '../assets/tile16x16.png')] private var fallingBlock:Class;
		[Embed(source = '../assets/Static.png')] private var Static:Class;
		[Embed(source = '../assets/FallingTile.png')] private var fallingTile:Class;
		[Embed(source = '../assets/Debris.png')] private var imgDebris:Class;
		[Embed(source = '../assets/VoidBG.png')] private var VoidBG:Class;
		...
		public function GameStateVoidLeft() 
		{
			super();
			...
			for (var i:int = 0; i < 20; i++) {
				for (var k:int = 0; k < FlxG.width; k++) {
					mapData += Math.ceil(FlxU.random() * 7).toString() + ",";
				}
				mapData += "\n"
			}
