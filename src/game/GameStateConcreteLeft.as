package game 
{
	 ...
	 */
	public class GameStateConcreteLeft extends FlxState 
	{
		[Embed(source = '../assets/ConcreteBuilding1.png')] private var stoneBlock:Class;
		[Embed(source = '../assets/BGGirder.png')] private var fallingBlock:Class;
		[Embed(source = '../assets/Static.png')] private var Static:Class;
		[Embed(source = '../assets/FallingTile.png')] private var fallingTile:Class;
		[Embed(source = '../assets/DeConcrete.png')] private var imgDebris:Class;
		[Embed(source = '../assets/ConcreteBuildingBGWindow1.png')] private var VoidBG:Class;
		...
		public function GameStateConcreteLeft() 
		{
			super();
			...
			for (var i:int = 0; i < 20; i++) {
				for (var k:int = 0; k < FlxG.width; k++) {
					mapData += Math.ceil(FlxU.random() * 3).toString() + ",";
				}
				mapData += "\n"
			}
