	...
	public class NexusMenu extends FlxSprite 
	{
		...
		public function NexusMenu(orbContainer:FlxGroup, X:Number = 0, Y:Number = 0, SimpleGraphic:Class = null) 
		{
			...
			for (var i:int = 0; i < numOrbs; i++) {
				...
				orb.x = FlxU.random() * 200;
				orb.y = FlxU.random() * 200;
			}
