package game 
{
	 ...
	 */
	public class GameStateCircutLeft extends FlxState 
	{
		[Embed(source = '../assets/CircuitBoard.png')] private var stoneBlock:Class;
		[Embed(source = '../assets/BGBattery.png')] private var fallingBlock:Class;
		[Embed(source = '../assets/Static.png')] private var Static:Class;
		[Embed(source = '../assets/FallingTile.png')] private var fallingTile:Class;
		[Embed(source = '../assets/DeCircuit.png')] private var imgDebris:Class;
		[Embed(source = '../assets/CircuitChunk.png')] private var VoidBG:Class;
		...
		public function GameStateCircutLeft() 
		{
			super();
			...
			for (var i:int = 0; i < 20; i++) {
				for (var k:int = 0; k < FlxG.width; k++) {
					mapData += Math.ceil(FlxU.random() * 2).toString() + ",";
				}
				mapData += "\n"
			}
