package game 
{
	 ...
	 */
	public class GameStateNotebookLeft extends FlxState 
	{
		[Embed(source = '../assets/NoteBook.png')] private var stoneBlock:Class;
		[Embed(source = '../assets/BGPencil.png')] private var fallingBlock:Class;
		[Embed(source = '../assets/Static.png')] private var Static:Class;
		[Embed(source = '../assets/FallingTile.png')] private var fallingTile:Class;
		[Embed(source = '../assets/DeNotebook.png')] private var imgDebris:Class;
		[Embed(source = '../assets/NotebookBG1.png')] private var VoidBG:Class;
		...
		public function GameStateNotebookLeft() 
		{
			super();
